package com.reed.storm.topoloys.test;
...
/**
 * Test publish msg to kafka
 * @author reed
 *
 */
public class TestTridentKafkaTopology {

	private static StormTopology buildTopology(String brokerConnectionString) {
		Fields fields = new Fields("word", "count");
		FixedBatchSpout spout = new FixedBatchSpout(fields, 4, new Values(
				"storm", "1"), new Values("trident", "1"), new Values("needs",
				"1"), new Values("javadoc", "1"));
		spout.setCycle(true);
	...
	public static void main(String[] args) throws Exception {
		String brokers = "172.28.20.103:9092";
		if (args.length < 1) {
			System.out
					.println("Please provide kafka broker url ,e.g. localhost:9092,defult is "
							+ brokers);
		} else {
			brokers = args[0];
		}
